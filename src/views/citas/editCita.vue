    ...
    <div class="container mt-5">
      <form class="p-4 bg-white shadow-lg rounded" style="width: 100%; max-width: 26rem;" @submit.prevent="updatedMedico">
        ...
        <div class="form-outline mb-4">
            ...
            <input type="text" id="form4Example1" class="form-control" v-model="fecha" />
        </div>
  
        <!-- Email input -->
        <div class="form-outline mb-4">
            <label class="form-label" for="form4Example2">Hora</label>
            <input type="email" id="form4Example2" class="form-control " v-model="hora" />
        </div>
        ...
        <button type="button" class="btn btn-danger btn-block mb-4 w-100 " @click="deleteCitas">
            Delete 
          </button>
      </form>
    </div>
...
<script setup>
    ...
    const endpoint = `http://127.0.0.1:8000/api/citas/${router.params.id}/` 
    const fecha = ref("")
    const hora = ref("")
    const id_medico = ref()
